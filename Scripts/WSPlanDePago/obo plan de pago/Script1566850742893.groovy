...
response = WS.sendRequest(findTestObject('WSPlanDePago/c2 plan de pago', [('r_access_token') : GlobalVariable.g_access_token
            , ('r_cuit') : GlobalVariable.g_cuit, ('r_plan') : GlobalVariable.g_planDePago]))

WS.verifyResponseStatusCode(response, 200)

WebUI.callTestCase(findTestCase('WSPlanDePago/validar response plan de pago'), [('t_response') : '', ('t_cuit') : '', ('t_campo') : ''
        , ('t_varCampo') : ''], FailureHandling.STOP_ON_FAILURE)
