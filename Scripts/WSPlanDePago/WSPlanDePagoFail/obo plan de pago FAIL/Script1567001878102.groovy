...
WebUI.callTestCase(findTestCase('WSPlanDePago/validar response plan de pago FAIL'), [('t_response') : response, ('t_cuit') : GlobalVariable.g_cuit, ('t_idPlan') : GlobalVariable.g_idPlan], FailureHandling.STOP_ON_FAILURE)
