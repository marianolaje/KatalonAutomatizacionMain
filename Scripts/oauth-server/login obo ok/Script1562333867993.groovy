...
response = WS.sendRequest(findTestObject('oauth-server/login on behalf of', [('r_servidor') : GlobalVariable.g_servidor_oauth
            , ('r_http_username') : 'klk-client', ('r_http_password') : 'klk-secret', ('r_username') : t_username, ('r_password') : t_password
            , ('r_onbehalfof') : t_onbehalfof]))
