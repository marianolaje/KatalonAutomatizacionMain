...
response = WS.sendRequest(findTestObject('oauth-server/login cidi', [('r_servidor') : GlobalVariable.g_servidor_oauth, ('r_http_username') : 'klk-client'
            , ('r_http_password') : 'klk-secret', ('r_cidi') : t_cidi]))
