...
response = WS.sendRequest(findTestObject('oauth-server/login b2b', [('r_servidor') : GlobalVariable.g_servidor_oauth, ('r_http_username') : 'klk-client'
            , ('r_http_password') : 'klk-secret', ('r_username') : t_username, ('r_password') : t_password]))
